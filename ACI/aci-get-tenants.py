...
def apic_login():
    ...
    try:
        response = requests.post(
            ...
            verify = False
            #The authenticity verification of the SSL certificate for the HTTPS session is disabled,
            #meaning self-signed SSL certificates will not cause the code to fail.
        )
